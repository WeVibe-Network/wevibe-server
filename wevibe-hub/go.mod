...
replace (
	// Temporary local links until Sprint 28 repos are published upstream.
	github.com/wevibe-network/wevibe-chain => ../../wevibe-chain
	github.com/wevibe-network/wevibe-sdk => ../../wevibe-sdk
)
